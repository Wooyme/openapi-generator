...
public class EnhancedAngularClientCodegen extends AbstractTypeScriptClientCodegen {
    ...
    public EnhancedAngularClientCodegen() {
        super();
        this.outputFolder = "generated-code/enhanced-angular";

        embeddedTemplateDir = templateDir = "enhanced-angular-client";
    ...
    public void postProcessModelProperty(CodegenModel model, CodegenProperty property) {
        ...
        String tmp = model.classname.substring(0,1).toLowerCase()+model.classname.substring(1);
        model.setXmlName(tmp);
